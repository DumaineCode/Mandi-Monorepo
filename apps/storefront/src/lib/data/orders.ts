...
export const retrieveOrder = async (id: string) => {
  ...
  return sdk.client
    .fetch<HttpTypes.StoreOrderResponse>(`/store/orders/${id}`, {
      ...
      query: {
        fields:
          "*payment_collections.payments,*items,*items.metadata,*items.variant,*items.product,*items.variant.product.images",
      },
      headers,
      next,
      cache: "force-cache",
  ...
  return sdk.client
    .fetch<HttpTypes.StoreOrderListResponse>(`/store/orders`, {
      ...
      query: {
        ...
        order: "-created_at",
        fields:
          "*items,+items.metadata,*items.variant,*items.product,*items.variant.product.images",
        ...filters,
      },
      headers,
      next,
